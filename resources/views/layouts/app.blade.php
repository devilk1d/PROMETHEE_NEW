    ...
    <div class="sidebar-nav">
        ...
        <ul class="list-unstyled">
            ...
            <li class="sidebar-item {{ request()->routeIs('criteria.*') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('criteria.index') }}">
                    <i class="bi bi-list-check"></i>
                    <span class="sidebar-link-text">
                        Criteria
                        @if(Auth::user()->isUser())
                            <small style="opacity: 0.7;">(View)</small>
                        @endif
                    </span>
                </a>
            </li>
            ...
            <li class="sidebar-item {{ request()->routeIs('decisions.*') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('decisions.index') }}">
            ...
            <div class="sidebar-cta">
                ...
                <a class="sidebar-cta-btn" href="{{ route('decisions.calculate') }}">
        ...
        <div class="dropdown">
            <div class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="user-info">
                    ...
                    <div class="user-role">
                        <span class="badge-modern badge-{{ Auth::user()->isAdmin() ? 'primary' : 'secondary' }}">
